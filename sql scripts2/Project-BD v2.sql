...
begin try
if @Perecedero = 1 
insert into Medicina values (@Nombre,@Perecedero,@Fecha_Ingreso,@Fecha_Lote,@Fecha_Caducidad,@Casa,@TipoMedicamento)
if @Perecedero = 0
insert into Medicina values (@Nombre,@Perecedero,@Fecha_Ingreso,@Fecha_Lote, NULL,@Casa,@TipoMedicamento)
end try
...
as
begin try
select ID_Medicina,Nombre,Perecedero,CONVERT(VARCHAR(20), Fecha_Ingreso, 103) as Fecha_Ingreso, CONVERT(VARCHAR(20), Fecha_Lote, 103)  as Fecha_Lote, CONVERT(VARCHAR(20), Fecha_Caducidad, 103) as Fecha_Caducidad, Casa, TipoMedicamento    from Medicina
end try 
begin catch
select
ERROR_PROCEDURE()as ErrorProcedure,
...
exec createMedicina 'GastroInter3000',1,'2022-10-11','2022-09-16','2022-01-01','Bayer','Digestivo'
exec createMedicina 'Complejo B',0,'2022-10-12','2022-09-15','2022-02-01','ByB','Nervioso'
exec createMedicina 'Cardio Aspirina',1,'2022-10-13','2022-09-14','2022-03-01','Faenco','Cardiologico'
exec createMedicina 'Vitamina C',0,'2022-10-14','2022-09-13','2022-04-01','Logitech','Vitaminas'
exec createMedicina 'Parecetamol (La vieja confiable)',1,'2022-10-15','2022-09-12','2022-05-01','MSI','Analgesicos'
exec createMedicina 'Te Natural',0,'2022-10-16','2022-09-11','2022-06-01','SyS','Natural'

exec createMedicina 'otra prueba',1,'2022-10-16','2022-09-11','2022-06-01','miau','cardiologo'
